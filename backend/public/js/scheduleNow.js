...
for (i=0;i<arr.length;i++){
    if (i != arr.length-1){
        ...
        document.getElementsByClassName("target")[i].parentNode.parentNode.style.display = "block" ;
        document.getElementsByClassName("target")[i].parentNode.parentNode.style.boxShadow= "0px 0px 5px 4px rgba(231,166,26,0.45)";}else{document.getElementsByClassName("target")[i].parentNode.parentNode.style.display = "none" ;}
        }else if (parseInt(texte.slice(0, 2))==parseInt(arr[i].innerHTML.slice(0, 2)) && parseInt(texte.slice(3, 5))>=parseInt(arr[i].innerHTML.slice(3, 5))){
            document.getElementsByClassName("target")[i].parentNode.parentNode.style.display = "block" ;
            document.getElementsByClassName("target")[i].parentNode.parentNode.style.boxShadow= "0px 0px 5px 4px rgba(231,166,26,0.45)";
        }else{document.getElementsByClassName("target")[i].parentNode.parentNode.style.display = "none" ;}}
